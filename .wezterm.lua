...
config.keys = {
  ...
  { key = 'r', mods = 'CTRL', action = act.PromptInputLine {
  ...
  -- Panes
  { key = 'h', mods = 'CTRL|SHIFT', action = act.SplitPane { direction = 'Left', command = {}, size = { Percent = 50, } } },
  { key = 'l', mods = 'CTRL|SHIFT', action = act.SplitPane { direction = 'Right', command = {}, size = { Percent = 50, } } },
  { key = 'k', mods = 'CTRL|SHIFT', action = act.SplitPane { direction = 'Up', command = {}, size = { Percent = 50, } } },
  { key = 'j', mods = 'CTRL|SHIFT', action = act.SplitPane { direction = 'Down', command = {}, size = { Percent = 50, } } },
